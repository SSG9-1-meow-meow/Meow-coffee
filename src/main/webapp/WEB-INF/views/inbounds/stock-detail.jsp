...
<div class="container mt-4">
  ...
  <table class="table table-bordered align-middle">
    ...
    <tr><th>상품의 구체적인 명칭</th><td>${stock.cfName} G2</td></tr>
    ...
    <tr><th>현재 적치 위치 (Detail)</th><td>${stock.lpId} </td></tr>
    <tr><th>지정 적치 위치 (최적)</th><td>A-4-1 </td></tr>
    <tr><th>요청 보관 조건</th><td>온도 20℃, 습도 60%</td></tr>
    <tr><th>재고 상태</th><td>가용 재고 </td></tr>
    <tr><th>다음 예정 작업</th><td>출고 대기</td></tr>
    </tbody>
  </table>
  <div class="text-end">
