...
VALUES
    ...
    ('CF005', '과테말라 안티구아', 'GUA', '디카페인', '프리미엄', '아라비카');
...
VALUES
    ...
    (3, 'CF005', 'LOC003', '승인완료', 60, '경기 성남 물류센터', 60, '2025-11-07 09:00:00', '2025-11-06 15:00:00', '2025-11-07 10:00:00'),
